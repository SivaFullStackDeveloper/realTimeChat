...
function getUserRooms(user)
{
    if(user&&user!="")
    {
        return groupUsersModel.find({userPhone:user}).populate('groupId','name admin image type');
        
    }else return [];
}

module.exports = { createGroup,addUser,getGroupDetailsbyRoom,getUserRooms,getRoomUsers,createCityGroup};